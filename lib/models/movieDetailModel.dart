...
MovieDetailModel welcomeFromJson(String str) => MovieDetailModel.fromJson(json.decode(str));

String welcomeToJson(MovieDetailModel data) => json.encode(data.toJson());
