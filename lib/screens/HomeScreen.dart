                          ...
                          onPageChanged: (index, reason) {
                            setState(
                              () {
                                ...
                                backdropPath = "https://image.tmdb.org/t/p/w600_and_h900_bestv2${TrendingController.trendingBackdropPath[index]}";
                              },
                            );
                          },
                        ),
                              ...
                              builder: (BuildContext context) {
                                return InkWell(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => SingleMediaScreen(id: i.id, mediaType: i.mediaType)),
                                    );
                                  },
                                  child: Container(
                                    width: width,
